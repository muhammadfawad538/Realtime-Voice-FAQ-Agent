...
const sttContract = fs.readFileSync(path.join(__dirname, 'src/services/stt/stt-contract.ts'), 'utf8');
...
const llmContract = fs.readFileSync(path.join(__dirname, 'src/services/llm/llm-contract.ts'), 'utf8');
...
const ttsContract = fs.readFileSync(path.join(__dirname, 'src/services/tts/tts-contract.ts'), 'utf8');
...
const voiceFlow = fs.readFileSync(path.join(__dirname, 'src/services/VoiceFlow.ts'), 'utf8');
...
const webSpeech = fs.readFileSync(path.join(__dirname, 'src/services/stt/WebSpeechRecognizer.ts'), 'utf8');
...
const geminiService = fs.readFileSync(path.join(__dirname, 'src/services/llm/GeminiService.ts'), 'utf8');
...
const featureDetection = fs.readFileSync(path.join(__dirname, 'src/utils/browser-feature-detection.ts'), 'utf8');
